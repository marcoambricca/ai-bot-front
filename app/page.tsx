 ...
 const features = [
  {
    ...
    description: "Automatiza tareas repetitivas y flujos de trabajo para ahorrar tiempo y reducir errores.",
    icon: <Zap className="size-5" />,
  },
  {
    title: "Análisis Avanzado",
    description: "Obtén información valiosa con visualización de datos e informes en tiempo real.",
    icon: <BarChart className="size-5" />,
  },
  {
    title: "Colaboración en Equipo",
    description: "Trabajen juntos sin problemas con herramientas de comunicación integradas.",
    icon: <Users className="size-5" />,
  },
  {
    title: "Seguridad Empresarial",
    description: "Mantén tus datos seguros con cifrado de extremo a extremo y funciones de cumplimiento.",
    icon: <Shield className="size-5" />,
  },
  {
    title: "Integración Perfecta",
    description: "Conéctate con tus herramientas favoritas a través de nuestro extenso ecosistema de API.",
    icon: <Layers className="size-5" />,
  },
  {
    title: "Soporte 24/7",
    description: "Recibe ayuda cuando la necesites con nuestro equipo de soporte dedicado.",
          ...
          <div className="container px-4 md:px-6 relative">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6 bg-clip-text text-transparent bg-gradient-to-r from-foreground to-foreground/70">
                Automatiza tus respuestas a clientes con Zen
              </h1>
              <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                Optimiza tu atención al cliente con nuestro bot inteligente. Automatiza respuestas y gestiona interacciones en WhatsApp y Gmail usando IA, liberando a tu equipo para tareas más complejas.
              </p>
              ...
              <div className="flex items-center justify-center gap-4 mt-6 text-sm text-muted-foreground">
                <div className="flex items-center gap-1">
                  ...
                  <span>Compatible con TiendaNube</span>
                </div>
                <div className="flex items-center gap-1">
                  <Check className="size-4 text-primary" />
